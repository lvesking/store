...
<div class="lf1">
    ...
    <div class="lf1_bottom">
        <div class="item_cat lf">
            ...
            <c:forEach items="${list2}"  varStatus="kt">
            
            	<p>${list2[kt.index].name}</p>
                <ul>
                <c:forEach items="${list3[kt.index]}" var="gc">
       ...
       <c:forEach items="${goodsList }" var="goods">
            ...
            <p class="bottom_ys2" style="width:198px;height:26px;">${goods.title }</p>
